...
export function PostCta({ locale }: PostCtaProps) {
  return (
    <aside className="glass mt-12 rounded-2xl p-8 text-center">
      <h3 className="text-xl font-bold text-cream">Download Tadado free</h3>
      <StoreBadges locale={locale} className="mt-6 justify-center" />
